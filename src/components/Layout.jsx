...
import { Menu, X, Home, Book, Camera, FileText, User, ClipboardList, BarChart2, LogOut } from "lucide-react";
...
export default function Layout() {
  ...
  const menuItems = [
    ...
    { name: "Add Book", path: "/add-book", icon: <Book size={18} /> },
    { name: "Borrow/Return", path: "/borrow-return", icon: <ClipboardList size={18} /> },
    { name: "Logs", path: "/face-recognition", icon: <Camera size={18} /> },
    { name: "Face Records", path: "/face-records", icon: <User size={18} /> },
    { name: "Register Face", path: "/register-face", icon: <User size={18} /> },
