...
export default function UserLayout() {
  ...
  const menuItems = [
    { name: "Home", path: "/user/home", icon: <Home size={18} /> },
    { name: "Browse Books", path: "/user/browse", icon: <ClipboardList size={18} /> },

    // ✅ NEWLY ADDED PAGE
    { name: "Reservations", path: "/user/reservations", icon: <Bookmark size={18} /> },

    { name: "Profile", path: "/user/profile", icon: <Book size={18} /> },
  ];
